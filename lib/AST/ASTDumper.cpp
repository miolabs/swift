...
std::string ROOT_DIR = "/Users/bubulkowanorka/projects/MIOFramework/MIOSwiftTranspiler";
std::string LIB_GENERATE_PATH = ROOT_DIR + "/include/";
...
const std::string RESERVED_VAR_NAMES[] = {"abstract","else","instanceof","super","switch","break","export","interface","synchronized","byte","extends","let","this","case","false","throw","catch","final","native","throws","finally","new","class","null","true","const","for","package","try","continue","function","private","typeof","debugger","protected","var","default","if","public","delete","implements","return","volatile","do","import","while","in","of","static","with","function","Infinity"};
...
std::string LIB_BODIES_PATH_AUTOGENERATED = ROOT_DIR + "/include/build-bodies/for-compiler/generated-by-step-2.txt";
std::string LIB_ADDITIONAL_BODY_PATH = ROOT_DIR + "/include/build-bodies/for-compiler/additional-bodies.txt";
std::unordered_map<std::string, std::string> LIB_BODIES;

std::string UNIQUE_NAMES_PATH = ROOT_DIR + "/include/build-bodies/for-compiler/unique-names.txt";
...
const std::unordered_map<std::string, std::string> OPERATOR_NAMES = {
  {"infix_60_60", "$bitwiseLeftShift"},
  {"infix_62_62", "$bitwiseRightShift"},
  {"infix_42", "$multiply"},
  {"infix_47", "$divide"},
  {"infix_37", "$remainder"},
  {"infix_38_42", "$multiplyIgnoringOverflow"},
  {"infix_38_47", "$divideIgnoringOverflow"},
  {"infix_38_37", "$remainderIgnoringOverflow"},
  {"infix_38", "$bitwiseAND"},
  {"infix_43", "$add"},
  {"infix_45", "$subtract"},
  {"infix_38_43", "$addWithOverflow"},
  {"infix_38_45", "$subtractWithOverflow"},
  {"infix_124", "$bitwiseOR"},
  {"infix_94", "$bitwiseXOR"},
  {"infix_46_46_60", "$halfOpenRange"},
  {"infix_46_46_46", "$closedRange"},
  {"infix_105_115", "$typeCheck"},
  {"infix_97_115", "$typeCast"},
  {"infix_63_63", "$nilCoalescing"},
  {"infix_60", "$lessThan"},
  {"infix_60_61", "$lessThanOrEqual"},
  {"infix_62", "$greaterThan"},
  {"infix_62_61", "$greaterThanOrEqual"},
  {"infix_61_61", "$equal"},
  {"infix_33_61", "$notEqual"},
  {"infix_61_61_61", "$identical"},
  {"infix_33_61_61", "$notIdentical"},
  {"infix_126_61", "$patternMatch"},
  {"infix_38_38", "$logicalAND"},
  {"infix_124_124", "$logicalOR"},
  {"infix_61", "$assign"},
  {"infix_42_61", "$multiplyAndAssign"},
  {"infix_47_61", "$divideAndAssign"},
  {"infix_37_61", "$remainderAndAssign"},
  {"infix_43_61", "$addAndAssign"},
  {"infix_45_61", "$subtractAndAssign"},
  {"infix_60_60_61", "$leftBitShiftAndAssign"},
  {"infix_62_62_61", "$rightBitShiftAndAssign"},
  {"infix_38_61", "$bitwiseANDAndAssign"},
  {"infix_94_61", "$bitwiseXORAndAssign"},
  {"infix_124_61", "$bitwiseORAndAssign"},
  {"infix_38_38_61", "$logicalANDAndAssign"},
  {"infix_124_124_61", "$logicalORAndAssign"},
  {"prefix_33", "$not"},
  {"prefix_126", "$bitwiseNot"},
  {"prefix_43", "$positive"},
  {"prefix_45", "$negate"},
  {"postfix_46_46_46", "$openEndedRange"}
};
...
//className:memberUserFacingName -> rootIdentifiers
std::unordered_map<std::string, std::vector<std::string>> classMemberBaseDefinitions;
//TODO read functionOverloadedCounts from include/.../libFunctionOverloadedCounts.txt
std::unordered_map<std::string, int> functionOverloadedCounts = {
  {"_isLess", 0},{"_dropLast", 0},{"_drop", 0},{"__copyContents", 0},{"_mergeRuns", 0},{"returnsAutoreleased", 0},{"_rawPointerToString", 0},{"_uint64ToStringImpl", 0},{"_float80ToStringImpl", 0},{"_float64ToStringImpl", 0},{"withBytes", 0},{"_uncheckedGetByte", 0},{"signGamma", 0},{"_suffix", 0},{"logGamma", 0},{"atan2", 0},{"gamma", 0},{"hypot", 0},{"erf", 0},{"_roundSlowPath", 0},{"decodeIfPresent", 0},{"_map", 0},{"nestedUnkeyedContainer", 0},{"encodeIfPresent", 0},{"encodeNil", 0},{"unkeyedContainer", 0},{"container", 0},{"_uncheckedSetByte", 0},{"_swift_stdlib_atomicFetchOrInt64", 0},{"_swift_stdlib_atomicFetchOrInt", 0},{"_swift_stdlib_atomicFetchAndInt64", 0},{"_swift_stdlib_atomicFetchAndInt32", 0},{"_swift_stdlib_atomicFetchAndInt", 0},{"_swift_stdlib_atomicFetchAddInt64", 0},{"_swift_stdlib_atomicFetchAddInt", 0},{"_swift_stdlib_atomicStoreInt", 0},{"_swift_stdlib_atomicCompareExchangeStrongInt", 0},{"compareExchange", 0},{"orAndFetch", 0},{"fetchAndOr", 0},{"andAndFetch", 0},{"fetchAndAdd", 0},{"store", 0},{"zip", 0},{"va_list", 0},{"_withVaList", 0},{"sequence", 0},{"pointwiseMax", 0},{"__copyToContiguousArray", 0},{"any", 0},{"infix_46_124_61", 0},{"infix_46_94_61", 0},{"infix_46_38_61", 0},{"infix_46_94", 0},{"prefix_46_33", 0},{"log1p", 0},{"log10", 0},{"expm1", 0},{"exp10", 0},{"exp2", 0},{"atanh", 0},{"asinh", 0},{"acosh", 0},{"tanh", 0},{"sinh", 0},{"cosh", 0},{"asin", 0},{"sin", 0},{"sqrt", 0},{"sum", 0},{"infix_46_62", 0},{"replacing", 0},{"infix_46_33_61", 0},{"infix_46_61_61", 0},{"unsafeCastElements", 0},{"_swift_stdlib_atomicFetchOrInt32", 0},{"descendant", 0},{"quickLookObject", 0},{"_superclassIterator", 0},{"_noSuperclassMirror", 0},{"appendRow", 0},{"_triangularNumber", 0},{"removeCollectionChanges", 0},{"_stdlib_atomicCompareExchangeStrongPtr", 0},{"appendFrontier", 0},{"formChangesCore", 0},{"formChanges", 0},{"_fastEnumeratedApply", 0},{"_float80ToString", 0},{"_validateChanges", 0},{"_stdlib_isOSVersionAtLeast", 0},{"_writeBackMutableSlice", 0},{"_isValid", 0},{"_measureCharacterStrideICU", 0},{"transcodedLength", 0},{"_copy", 0},{"trailSurrogate", 0},{"leadSurrogate", 0},{"_decodeSurrogates", 0},{"getVaList", 0
CStringTrampoline", 0},{"_customIndexOfEquatableElement", 0},{"infix_46_60_61", 0},{"_setDownCast", 0},{"_stdlib_initializeReturnAutoreleased", 0},{"_initializeBridgedValues", 0},{"objectEnumerator", 0},{"requestNativeBuffer", 0},{"elementsEqual", 0},{"_isNotOverlong_F0", 0},{"_initializeBridgedKeys", 0},{"_forceBridgeFromObjectiveC", 0},{"_dictionaryUpCast", 0},{"_forEach", 0},{"mapError", 0},{"_float64ToString", 0},{"append", 0},{"updateValue", 0},{"_isOptional", 0},{"$lessThanOrEqual", 0},{"write", 0},{"$add", 0},{"lookup", 0},{"$lessThan", 0},{"_finalizeRuns", 0},{"merge", 0},{"_minimumMergeRunLength", 0},{"_convertToAnyHashable", 0},{"validate", 0},{"_invariantCheck", 0},{"withMutableCapacity", 0},{"type", 0},{"$leftBitShiftAndAssign", 0},{"_unsafeMinus", 0},{"dump", 0},{"print", 0},{"_isPOD", 0},{"isLess", 0},{"_getElementSlowPath", 0},{"bindMemory", 0},{"_customContainsEquatableElement", 0},{"_isUnique", 0},{"_uint64ToString", 0},{"_swift_class_getSuperclass", 0},{"_outlinedMakeUniqueBuffer", 0},{"_makeNativeBridgeObject", 0},{"_hash", 0},{"sorted", 0},{"_bridgeObject", 0},{"addProduct", 0},{"_copyToNewBuffer", 0},{"_openExistential", 0},{"bridgeElements", 0},{"delete", 0},{"_getNonTagBits", 0},{"_cocoaPath", 0},{"_class_getInstancePositiveExtentSize", 0},{"_parseASCIISlowPath", 0},{"_roundUpImpl", 0},{"_getUnsafePointerToStoredProperties", 0},{"unsafeDowncast", 0},{"reserveCapacity", 0},{"_ensureBidirectional", 0},{"_bridgeAnythingNonVerbatimToObjectiveC", 0},{"_bridgeAnythingToObjectiveC", 0},{"_dump_unlocked", 0},{"_unbox", 0},{"checkOccupied", 0},{"_hoistableIsNativeTypeChecked", 0},{"_forceCreateUniqueMutableBufferImpl", 0},{"_collectReferencesInsideObject", 0},{"_makeObjCBridgeObject", 0},{"_isOccupied", 0},{"_dumpPrint_unlocked", 0},{"_isClassOrObjCExistential", 0},{"sort", 0},{"removeFirst", 0},{"_swift_isClassOrObjCExistentialType", 0},{"_getObjCTypeEncoding", 0},{"getRuntimeFunctionNames", 0},{"$logicalAND", 0},{"_failEarlyRangeCheck", 0},{"key", 0},{"_makeCollectionDescription", 0},{"_slowUTF8CString", 0},{"_swift_classOfObjCHeapObject", 0},{"printForDebuggerImpl", 0},{"_typeCheck", 0},{"_conditionallyUnreachable", 0},{"_copying", 0},{"$notEqual", 0},{"isOnGraphemeClusterBoundary", 0},{"_reinterpretCastToAnyObject", 0},{"_isUniquelyReferenced", 0},{"_bridgeToObjectiveCImpl", 0},{"unsafeBitCast", 0},{"Hashable_isEqual_indirect", 0},{"ELEMENT_TYPE_OF_SET_VIOLATES_HASHABLE_REQUIREMENTS", 0},{"_nonPointerBits", 0},{"cast", 0},{"passRetained", 0},{"_roundUp", 0},{"_getTypeByMangledNameInContext", 0},{"isUniquelyReferencedNative", 0},{"flatMap", 0},{"_utf8ScalarLength", 0},{"popFirst", 0},{"uncheckedInsert", 0},{"lexicographicallyPrecedes", 0},{"_onFastPath", 0},{"_getBridgedNonVerbatimObjectiveCType", 0},{"bucket", 0},{"_getNormalizedType", 0},{"_assertionFailure", 0},{"_isBridgedToObjectiveC", 0},{"pointwiseMin", 0},{"_fromSubstring", 0},{"asStringRepresentation", 0},{"infix_46_60", 0},{"hashValue", 0},{"_swift_stdlib_atomicFetchXorInt64", 0},{"_makeKeyValuePairDescription", 0},{"_getElementAddress", 0},{"_bridgeNonVerbatimBoxedValue", 0},{"_unsafeUnbox", 0},{"_precondition", 0},{"_makeMutableAndUnique", 0},{"_isObjCTaggedPointer", 0},{"_arrayDownCastIndirect", 0},{"$identical", 0},{"appendLiteral", 0},{"allocate", 0},{"encodeConditional", 0},{"join", 0},{"withFastCChar", 0},{"_undefined", 0},{"$bitwiseANDAndAssign", 0},{"_partitionImpl", 0},{"requestUniqueMutableBackingBuffer", 0},{"_isValidArraySubscript", 0},{"_findStringSwitchCaseWithCache", 0},{"_slowCompare", 0},{"_unsafeUncheckedDowncast", 0},{"utf16Offset", 0},{"_roundingUpToAlignment", 0},{"withoutActuallyEscaping", 0},{"_slowPath", 0},{"_checkValidSubscript", 0},{"_unconditionallyBridgeFromObjectiveC", 0},{"_unsafeInsertNew", 0},{"_commonPrefix", 0},{"uniqueNativeReplaceSubrange", 0},{"_autorelease", 0},{"_modifyAtReferenceWritableKeyPath_impl", 0},{"isTotallyOrdered", 0},{"withContiguousStorageIfAvailable", 0},{"_typeCheckSlowPath", 0},{"intersecting", 0},{"uncheckedRemove", 0},{"isKnownUniquelyReferenced", 0},{"$halfOpenRange", 0},{"_delete", 0},{"_getBridgedObjectiveCType", 0},{"stride", 0},{"$openEndedRange", 0},{"asObjectAddress", 0},{"_cocoaStringCompare", 0},{"_modifyAtWritableKeyPath_impl", 0},{"uncheckedContains", 0},{"$closedRange", 0},{"fetchAndAnd", 0},{"_checkSubscript", 0},{"isValid", 0},{"exp", 0},{"split", 0},{"ensureUnique", 0},{"init", 0},{"inferringMoves", 0},{"_hasGraphemeBreakBetween", 0},{"bit", 0},{"clamp", 0},{"_fastPath", 0},{"precondition", 0},{"_findStringSwitchCase", 0},{"_getRetainCount", 0},{"difference", 0},{"withUnsafeMutablePointerToElements", 0},{"_preconditionFailure", 0},{"dividedReportingOverflow", 0},{"lastIndex", 0},{"_bridgeToObjectiveC", 0},{"_resolveKeyPathGenericArgReference", 0},{"max", 0},{"popLast", 0},{"_uncheckedUnsafeAssume", 0},{"fastUTF8ScalarLength", 0},{"_isNonTaggedObjCPointer", 0},{"make", 0},{"storeBytes", 0},{"$subtract", 0},{"moveEntry", 0},{"_isDebugAssertConfiguration", 0},{"last", 0},{"_unsafeReferenceCast", 0},{"_allocateBufferUninitialized", 0},{"_debugPrecondition", 0},
},{"_foreignOpaqueCharacterStride", 0},{"_forceCreateUniqueMutableBuffer", 0},{"_cocoaUTF8Pointer", 0},{"round", 0},{"downcast", 0},{"subscript", 0},{"appendInPlace", 0},{"_withUnsafeGuaranteedRef", 0},{"_overflowChecked", 0},{"_makeIterator", 0},{"_minAllocationAlignment", 0},{"_asCocoaArray", 0},{"isUniquelyReferenced", 0},{"_getElement", 0},{"_allocateUninitializedArray", 0}
};
...
std::string cloneStruct(Expr *rExpr, std::string baseStr) {
...
std::string getFunctionName(ValueDecl *D, std::string uniqueIdentifier) {
  ...
  if(!functionUniqueNames.count(uniqueIdentifier)) {
    if(D->isOperator()) {
      ...
      if(OPERATOR_NAMES.count(stringifiedOp)) stringifiedOp = OPERATOR_NAMES.at(stringifiedOp);
...
std::string getName(ValueDecl *D, unsigned long satisfiedProtocolRequirementI = 0) {
  ...
  //TODO maybe a flag at the start
  if(name.find("MIO") == 0 && name.find("MIO_Mixin_") == std::string::npos) {
    name = "NS" + name.substr(3);
  }
  ...
  if(nameReplacementsByDecl.count(D)) {
    return nameReplacementsByDecl[D];
  }
...
namespace {
  ...
  public:
          ...
          for(Decl *member : members) {
            if(auto *memberVD = dyn_cast<ValueDecl>(member)) {
              ...
              if(auto *memberVarD = dyn_cast<VarDecl>(member)) {
                ...
                else if(getTypeName(memberVarD->getType()) == "(unmanaged_storage_typeOptional)") {
                  isOptional = true;
                }
              }
    ...
    void visitSourceFile(const SourceFile &SF) {
      ...
      std::ifstream infile(UNIQUE_NAMES_PATH);
      std::string line, key;
      while (std::getline(infile, line)) {
        if(key.length()) {
          functionUniqueNames[key] = line;
          key = "";
        }
        else key = line;
      }
      ...
      if(LIB_GENERATE_MODE) {
        for(int i = 0; i < 4; i++) {
          std::ifstream infile(i == 3 ? LIB_ADDITIONAL_BODY_PATH : i == 2 ? LIB_BODIES_PATH_AUTOGENERATED : i ? LIB_BODIES_PATH_MANUAL_SWIFT : LIB_BODIES_PATH_MANUAL);
          ...
          while (std::getline(infile, line)) {
            ...
            if(lineIsKey) {
              if(key.length()) {
                if(i == 3) {
                  LIB_ADDITIONAL_BODY[key] = val;
                }
                else if(!LIB_BODIES.count(key)) {
                  LIB_BODIES[key] = val;
                }
              }
              key = line.substr(4);
    ...
    void visitPatternBindingDecl(PatternBindingDecl *PBD) {
      ...
      for (auto entry : PBD->getPatternList()) {
        ...
        if((!isOverriden || entry.getInit()) && (!LIB_GENERATE_MODE || isProtocol)) {
          ...
          OS << "\n" + varDecl;
          if(entry.getInit()) {
            std::string initStr = " = " + cloneStruct(entry.getInit(), dumpToStr(entry.getInit()));
    ...
    std::string printAbstractFunc(AbstractFunctionDecl *FD, ValueDecl *NameD = nullptr, std::string suffix = "") {
      ...
      if(LIB_GENERATE_MODE) {
        std::vector<std::string> rootIdentifiers;
        str += "/*" + getMemberIdentifier(NameD) + "*/\n";
        for(unsigned long i = 0; ; i++) {
          auto *declRoot = getDeclRoot(NameD, i);
          if(!declRoot) break;
          str += "/*" + getMemberIdentifier(declRoot) + "*/\n";
          rootIdentifiers.push_back(getMemberIdentifier(declRoot));
        }
        std::string overloadIdentifier;
        llvm::raw_string_ostream stream(overloadIdentifier);
        printContext(stream, FD->getDeclContext());
        stream.flush();
        overloadIdentifier += "." + functionName;
        if(classMemberBaseDefinitions.count(overloadIdentifier)) {
          bool different = rootIdentifiers.size() != classMemberBaseDefinitions[overloadIdentifier].size();
          for(unsigned i = 0; !different && i < rootIdentifiers.size(); i++) {
            different = rootIdentifiers[i] != classMemberBaseDefinitions[overloadIdentifier][i];
          }
          if(different) str += "/*!!!DUPLICATE NAME*/\n";
        }
        else {
          classMemberBaseDefinitions[overloadIdentifier] = rootIdentifiers;
        }
      ...
      if(auto *CD = dyn_cast<ConstructorDecl>(FD)) {
        if (CD->getFailability() != OTK_None && (!FD->getDeclContext()->getSelfProtocolDecl() || FD->getDeclContext()->getExtendedProtocolDecl())) {
          str += "\nstatic readonly " + functionName + "$failable = true";
        }
      }
...
public:
  ...
  void printRec(Stmt *S) {
    ...
    if (S)
      ...
      OS.indent(Indent) << "null";//"/**NULL STATEMENT**/"
    Indent -= 2;
  }
  ...
  void visitBraceStmt(BraceStmt *S) {
    ...
    if(braceStmtsArchetypeClarifications.count(S)) {
      braceStmtsArchetypeClarifications.erase(S);
    }
  ...
  IfLet getConditionAndInitializerStr(StmtCondition conditions) {
    ...
    for (auto elt : conditions) {
      if (auto booleanOrNull = elt.getBooleanOrNull()) {
        if (condition.length()) condition += " && ";
        condition += "(" + dumpToStr(booleanOrNull) + ")";
      }
...
public:
  ...
  void printRec(Expr *E) {
    ...
    if (E)
      ...
      OS.indent(Indent) << "null";//"/**NULL EXPRESSION**/"
    Indent -= 2;
  }
  ...
  void visitStringLiteralExpr(StringLiteralExpr *E) {
    ...
    std::string str;
    llvm::raw_string_ostream stream(str);
    stream << QuotedString(E->getValue());
    stream.flush();
    
    if(str.find("\"#clarifyGeneric") == 0) {
      if(!braceStmtsArchetypeClarifications.count(openedBraceStmts.back())) {
        braceStmtsArchetypeClarifications[openedBraceStmts.back()] = {};
      }
      int dash0 = str.find("#", 2), dash1 = str.find("#", dash0 + 1);
      std::string chunk0 = str.substr(dash0 + 1, dash1 - dash0 - 1);
      std::string chunk1 = str.substr(dash1 + 1, str.length() - dash1 - 1 - 1);
      braceStmtsArchetypeClarifications[openedBraceStmts.back()][chunk0] = chunk1;
      return;
    }
  ...
  void visitMagicIdentifierLiteralExpr(MagicIdentifierLiteralExpr *E) {
    ...
    OS << "null";//"/*magic_identifier_literal_expr*/"
  }
  ...
  void visitInOutExpr(InOutExpr *E) {
    ...
    std::string setStr = handleLAssignment(E->getSubExpr(), cloneStruct(E->getSubExpr(), "$val"));
  ...
  std::string handleInfo(std::string lrString, Expr *lExpr, bool isSubscriptAss = false, bool isCreate = false) {
    ...
    if(passSetThis) {
      std::string setStr = handleLAssignment(rExpr, cloneStruct(rExpr, "$val"));
    ...
    if(iString == "{}" && lrString.find(", #I") != std::string::npos && !isCreate) {
      lrString = std::regex_replace(lrString, std::regex(", #I"), regex_escape(""));
    }
    else {
      ...
      if (auto initDeclRef = dyn_cast<DeclRefExpr>(lConstructor->getFn())) {
        if (auto initDecl = dyn_cast<ConstructorDecl>(initDeclRef->getDecl())) {
          ...
          if(replacement.length()) {
            ...
            lString = handleInfo(lString, initDeclRef, false, true);
          }
          defaultSuffix = "";
        }
      }
  ...
  bool archetypeTypesEqual(Type A, Type B) {

    //that's to display e.g. `Double` instead of `Double.Type` when referring to the class itself
    if(auto *metatypeType = dyn_cast<AnyMetatypeType>(A.getPointer())) {
      A = metatypeType->getInstanceType();
    }
    ...
    if(auto *archetypeTypeA = dyn_cast<ArchetypeType>(A.getPointer())) {
      if(auto *archetypeTypeB = dyn_cast<ArchetypeType>(B.getPointer())) {
        return archetypeTypeA->getFullName() == archetypeTypeB->getFullName();
      }
    }
    return false;
  }
  
  void clarifyArchetypeTypeForBinaryExpr(ApplyExpr *E) {
    
    if(auto *dotSyntaxCallExpr = dyn_cast<DotSyntaxCallExpr>(E->getFn())) {
      if(auto *typeExpr = dyn_cast<TypeExpr>(skipInOutExpr(dotSyntaxCallExpr->getArg()))) {
        if(auto *tupleExpr = dyn_cast<TupleExpr>(E->getArg())) {
  ...
  void visitPrefixUnaryExpr(PrefixUnaryExpr *E) {
    clarifyArchetypeTypeForBinaryExpr(E);
    printApplyExpr(E->getFn(), E->getArg());
  }
  ...
  void visitAssignExpr(AssignExpr *E) {
    ...
    std::string rStr = cloneStruct(E->getSrc(), dumpToStr(E->getSrc()));
  ...
  void visitOptionalEvaluationExpr(OptionalEvaluationExpr *E) {
    ...
    bool injectIntoOptional = false;
    if(auto *injectExpr = dyn_cast<InjectIntoOptionalExpr>(subExpr)) {
      subExpr = injectExpr->getSubExpr();
      injectIntoOptional = true;
    }
...
//        }
//      }
//      for(auto *FD : openFunctions) {
//        for (auto P : *FD->getParameters()) {
//          if(P->getType()->isEqual(T)) {
//            OS << getName(P);
//            if(!noGenericAccess) OS << ".constructor";
//            return;
//          }
...
//      }
      ...
      for(auto *braceStmt : openedBraceStmts) {
        if(braceStmtsArchetypeClarifications.count(braceStmt) && braceStmtsArchetypeClarifications[braceStmt].count(T->getFullName())) {
          OS << braceStmtsArchetypeClarifications[braceStmt][T->getFullName()];
          return;
        }
      }
    ...
    void visitNestedArchetypeType(NestedArchetypeType *T, StringRef label) {
      ...
      while(true) {
        if(auto *NAT = dyn_cast<NestedArchetypeType>(base)) {
          for(auto *member : getAllMembers(NAT->getAssocType()->getProtocol(), false).members) {
            if(auto *varMember = dyn_cast<VarDecl>(member)) {
              if(auto *memberNAT = dyn_cast<NestedArchetypeType>(varMember->getType().getPointer())) {
                if(memberNAT->getAssocType() == NAT->getAssocType()) {
                  chain = '.' + getName(varMember) + chain;
                  break;
                }
              }
            }
