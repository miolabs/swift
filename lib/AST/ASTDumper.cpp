...
bool isNative(std::string uniqueIdentifier) {
  return uniqueIdentifier.find("Swift.(file).") == 0 || uniqueIdentifier.find("XCTest.(file).") == 0 || uniqueIdentifier.find("ObjectiveC.(file).") == 0 || uniqueIdentifier.find("Darwin.(file).") == 0 || uniqueIdentifier.find("Foundation.(file).") == 0 || uniqueIdentifier.find("UIKit.(file).") == 0 || uniqueIdentifier.find("CoreData.(file).") == 0 || uniqueIdentifier.find(".(file).MIO") > 0 || PRINT_EXTENSION;
}
